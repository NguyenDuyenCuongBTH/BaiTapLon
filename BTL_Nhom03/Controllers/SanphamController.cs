...
namespace BTL_Nhom03.Controllers
{
    public class SanphamController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaSP,TenSP,Size,SoLuong,MauSac,GiaTien")] Sanpham sanpham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaSP,TenSP,Size,SoLuong,MauSac,GiaTien")] Sanpham sanpham)
        {
            if (id != sanpham.MaSP)
            {
                return NotFound();
