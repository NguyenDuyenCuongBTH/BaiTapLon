...
namespace BTL_Nhom03.Controllers
{
    public class KhachhangController : Controller
    {
        ...
        {
            var newquanao = "KH001";
            var countquanao = _context.Khachhang .Count();
            if (countquanao > 0)
            {
                var IDSp = _context.Khachhang.OrderByDescending(m => m.MaKhachHang).First().MaKhachHang;
        ...
        public async Task<IActionResult> Create([Bind("MaKhachHang,TenKhachHang,DiaChi,Sdt")] Khachhang khachhang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaKhachHang,TenKhachHang,DiaChi,Sdt")] Khachhang khachhang)
        {
